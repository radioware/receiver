...
circbuf_ctx *circbuf_init(const char *name, size_t item_size, size_t payload_size, size_t size) {
    circbuf_ctx *ctx;
    int result;
    size_t ln;
...
void *circbuf_head_acquire(circbuf_ctx *ctx) {
    void *ptr;
    size_t pos;
...
void *circbuf_tail_acquire(circbuf_ctx *ctx) {
    void *ptr;
    size_t pos;
