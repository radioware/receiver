...
#ifndef __RADIOWARE_RECEIVER__CFG__H
#define __RADIOWARE_RECEIVER__CFG__H
...
struct cfg_t {
    ...
    bool_flag rtlsdr_scan_enable;
    uint32_t rtlsdr_scan_start_freq;
    uint32_t rtlsdr_scan_end_freq;
    uint32_t rtlsdr_scan_step_freq;
