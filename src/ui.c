...
void ui_help() {
    ...
    ui_message("\n");
    ui_message("    -q | --quiet             Disable output (UI log level DISABLE)\n");
    ui_message("    -v | --verbose           Verbose output (UI log level DEBUG)\n");
    ui_message("\n");
    ...
    ui_message("                                          - 1 Manual\n");
    ui_message("\n");
    ui_message("    -g | --rtlsdr-device-tuner-gain       Tune gain in tenths of dB (%d)\n",
